 ...
 * {@link io.atomix.storage.journal.Journal} and replicated to other members
...
public interface RaftServer {
   ...
   * The name is used internally to manage the server's on-disk state. {@link io.atomix.storage.journal.Journal Log},
